...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pTankMesh->LoadMesh("C:/Content/phoenix_ugv.md2")) {
            return false;
        }
        
        m_pSkyBox = new SkyBox(m_pGameCamera, m_persProjInfo);
        
        if (!m_pSkyBox->Init("C:/Content",
                             "C:/Content/sp3right.jpg",
                             "C:/Content/sp3left.jpg",
                             "C:/Content/sp3top.jpg",
                             "C:/Content/sp3bot.jpg",
                             "C:/Content/sp3front.jpg",
                             "C:/Content/sp3back.jpg")) {
            return false;
        }
